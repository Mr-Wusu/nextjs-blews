...
function CartSummary() {
  return (
    <div className="flex flex-col gap-4 w-[90%] max-w-[26rem] lg:self-start">
      <main className="flex flex-col gap-[1.2px] bg-rose-300 h-fit rounded-[.75rem] overflow-hidden shadow-sm shadow-black">
      ...
      <aside className="flex flex-col gap-3 bg-rose-100 rounded-[.75rem] py-2 px-3 shadow-sm shadow-black">
